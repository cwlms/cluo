...
from cluo.stages import MasterMatchStageV3_4
...
def db_with_companies_table(get_connection_pool):
    ...
    cur.execute(
        "CREATE TABLE master.companies (id int, company_name varchar, website varchar, data_source_keys text[], ts_status varchar, ts_updated timestamp, date_field date, array_hash text[]);"
    )
    yield cur
...
@parametrize_processes(MasterMatchStageV3_4)
def test_master_match_stage(db_with_companies_table, get_connection_pool, processes):
    ...
    cur.execute(
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1234, 'Test Company', 'testcompany.com', '{\"test_id1\"}', '{\"hash1\"}');"
    )

    stage = MasterMatchStageV3_4(
...
def test_master_match_order_by_updated(
    ...
    cur.execute(
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1234, 'Test Company', 'testcompany.com', '{\"test_id1\", \"test_id2\"}', '{\"hash1\", \"hash2\"}');"
    )
...
def test_master_match_order_by_custom(
    ...
    cur.execute(
        'INSERT INTO master.companies (id, data_source_keys, array_hash) VALUES (1, \'{"test_id1", "test_id2", "test_id3", "test_id4", "test_id5", "test_id6", "test_id7", "test_id8", "test_id9"}\', \'{"hash1", "hash2"}\');'
    )
...
@parametrize_processes(MasterMatchStageV3_4)
def test_master_match_high_match_ratio(
    db_with_companies_table, get_connection_pool, processes
):
    cur = db_with_companies_table
    cur.execute(
        """
            INSERT INTO clean.companies (id, company_name, website, array_hash, data_source_key, ts_updated) VALUES
                (1234, 'Test Company',   'testcompany.com',  '{\"hash1\", \"hash2\"}', 'test_id1', '2020-01-01 01:01:01.000'::timestamp),
                (1235, 'Test Company 2', 'testcompany2.com', '{\"hash2\", \"hash3\"}', 'test_id2', '2020-01-01 01:01:01.001'::timestamp)
        """
    )
    cur.execute(
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1234, 'Test Company', 'testcompany.com', '{\"test_id1\"}', '{\"hash1\", \"hash2\", \"hash3\"}');"
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1235, 'Test Company 2', 'testcompany.com', '{\"test_id2\"}', '{\"hash2\", \"hash3\"}');"
    )
...
@parametrize_processes(MasterMatchStageV3_4)
def test_master_match_low_match_ratio(
    db_with_companies_table, get_connection_pool, processes
):
    cur = db_with_companies_table
    cur.execute(
        """
            INSERT INTO clean.companies (id, company_name, website, array_hash, data_source_key, ts_updated) VALUES
                (1234, 'Test Company',   'testcompany.com',  '{\"hash1\", \"hash2\"}', 'test_id1', '2020-01-01 01:01:01.000'::timestamp),
                (1235, 'Test Company 2', 'testcompany2.com', '{\"hash2\", \"hash3\"}', 'test_id2', '2020-01-01 01:01:01.001'::timestamp),
                (1236, 'Test Company 3', 'testcompany3.com', '{\"hash3\", \"hash4\"}', 'test_id3', '2020-01-01 01:01:01.002'::timestamp)
        """
    )
    cur.execute(
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1234, 'Test Company', 'testcompany.com', '{\"test_id1\"}', '{\"hash1\", \"hash2\", \"hash3\"}');"
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1235, 'Test Company 2', 'testcompany2.com', '{\"test_id2\"}', '{\"hash2\", \"hash3\"}');"
        "INSERT INTO master.companies (id, company_name, website, data_source_keys, array_hash) VALUES (1236, 'Test Company 3', 'testcompany3.com', '{\"test_id3\"}', '{\"hash3\", \"hash4\"}');"
    )
