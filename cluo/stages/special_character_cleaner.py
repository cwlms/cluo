...
class SpecialCharacterCleanerStage(FieldProcessorStage):
    """Remove special characters from specified strings."""
    ...
    def __init__(
        ...
        """Initialize `SpecialCharacterCleanerStage`.
    ...
    def process_field(self, field: Any, field_value: Any) -> Any:
        return unidecode.unidecode(field_value)
